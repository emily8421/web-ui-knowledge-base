...
- 容易误解的表达：
- 需要免责声明或风险提示的位置：
- 默认 UI 标准基线（如后台 / 知识库工作台 / 数据密集表格 / 问答界面 / 营销页）：
- 信息密度 / 字号 / 行高倾向：
...
- 回填到 `00-03` 的事项：
- 回填到 `docs/design/frontend-experience-brief.md` 的已确认体验原则：
- 回填到 `docs/design/frontend-interaction.md` / UI 原型策略的事项：
- 后续 `08/09` 建议但暂未生效的事项：
- 需要继续探索的事项：
- 进入 `04-05` 前必须确认的事项：
